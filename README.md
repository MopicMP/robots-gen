...
[![PyPI version](https://badge.fury.io/py/robots-gen.svg)](https://pypi.org/project/robots-gen/)
...
```bash
pip install robots-gen
```

## Quick Start

```python
from robots_gen import gen
